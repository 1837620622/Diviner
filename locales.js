...
(function () {
  ...
  var zh = {
    ...
    'status.websearchSkipped': '联网参详未果 · 依本门所学直断',
    ...
    // ── 四柱八字弹窗 ──
    'bazi.title': '四柱八字 · 确定性排盘',
    'bazi.kicker': '录入生辰 · 历法引擎即时排定四柱',
    'bazi.calTypeLabel': '历法',
    'bazi.calSolar': '公历',
    'bazi.calLunar': '农历',
    'bazi.yearLabel': '出生年',
    'bazi.yearPlaceholder': '例：1995',
    'bazi.monthLabel': '出生月',
    'bazi.lunarMonthLabel': '农历月',
    'bazi.dayLabel': '出生日',
    'bazi.lunarDayLabel': '农历日',
    'bazi.hourLabel': '出生时辰',
    'bazi.hour.0': '早子时（00:00–01:00）',
    'bazi.hour.2': '丑时（01:00–03:00）',
    'bazi.hour.4': '寅时（03:00–05:00）',
    'bazi.hour.6': '卯时（05:00–07:00）',
    'bazi.hour.8': '辰时（07:00–09:00）',
    'bazi.hour.10': '巳时（09:00–11:00）',
    'bazi.hour.12': '午时（11:00–13:00）',
    'bazi.hour.14': '未时（13:00–15:00）',
    'bazi.hour.16': '申时（15:00–17:00）',
    'bazi.hour.18': '酉时（17:00–19:00）',
    'bazi.hour.20': '戌时（19:00–21:00）',
    'bazi.hour.22': '亥时（21:00–23:00）',
    'bazi.hour.23': '晚子时（23:00–24:00）',
    'bazi.genderLabel': '性别',
    ...
    'bazi.leapCheck': '生于闰月',
    'bazi.leapNoteHas': '此年有闰{m}月；若生于闰月请勾选。',
    'bazi.leapNoteNone': '此年无闰月。',
    'bazi.calcBtn': '即刻排盘',
    'bazi.errDate': '请先填写有效的出生年月日。',
    'bazi.errLunarDate': '请填写有效的农历月日（月 1–12，日 1–30）。',
    'bazi.errLeapMismatch': '此年该月并非闰月，请取消闰月勾选或改用公历。',
    'bazi.errCalendar': '该日期历法换算未能完成，请核对日期或改用公历录入。',
    'bazi.errDateSubmit': '请先完整填写出生年月日。',
    'bazi.pillarYear': '年柱',
    'bazi.pillarMonth': '月柱',
    'bazi.pillarDay': '日柱',
    'bazi.pillarHour': '时柱',
    'bazi.dayMasterMark': '日主',
    'bazi.dayMasterIs': '日主',
    'bazi.zodiac': '属',
    'bazi.elDist': '五行盘面',
    'bazi.el.wood': '木',
    ...
    'bazi.reviewNoCity': '尚未填写出生城市。',
    'bazi.reviewNote': '资料已录入；正式四柱、节气交接与真太阳时由后续推演校核，本页不会伪造干支结果。',
    'bazi.guideAfterChart': '命盘已排定誊入呈匣。可再补充当下所问之事（事业、姻缘或流年），随后亲手呈递。',
  ...
  var en = {
    ...
    'status.draftReady': 'The chart is drawn · Awaiting your submission',
    ...
    'status.websearchSkipped': 'Web consultation unavailable · reading from inner knowledge',
    ...
    // ── 四柱八字弹窗 ──
    'bazi.title': 'Four Pillars of Destiny · Precise Chart',
    'bazi.kicker': 'Enter your birth data · The calendar engine casts the Four Pillars instantly',
    'bazi.calTypeLabel': 'Calendar',
    'bazi.calSolar': 'Solar',
    'bazi.calLunar': 'Lunar',
    'bazi.yearLabel': 'Year of birth',
    'bazi.yearPlaceholder': 'e.g. 1995',
    'bazi.monthLabel': 'Month of birth',
    'bazi.lunarMonthLabel': 'Lunar month',
    'bazi.dayLabel': 'Day of birth',
    'bazi.lunarDayLabel': 'Lunar day',
    'bazi.hourLabel': 'Hour of birth',
    'bazi.hour.0': 'Zi hour, early (00:00–01:00)',
    'bazi.hour.2': 'Chou hour (01:00–03:00)',
    'bazi.hour.4': 'Yin hour (03:00–05:00)',
    'bazi.hour.6': 'Mao hour (05:00–07:00)',
    'bazi.hour.8': 'Chen hour (07:00–09:00)',
    'bazi.hour.10': 'Si hour (09:00–11:00)',
    'bazi.hour.12': 'Wu hour (11:00–13:00)',
    'bazi.hour.14': 'Wei hour (13:00–15:00)',
    'bazi.hour.16': 'Shen hour (15:00–17:00)',
    'bazi.hour.18': 'You hour (17:00–19:00)',
    'bazi.hour.20': 'Xu hour (19:00–21:00)',
    'bazi.hour.22': 'Hai hour (21:00–23:00)',
    'bazi.hour.23': 'Zi hour, late (23:00–24:00)',
    ...
    'bazi.leapCheck': 'Born in a leap month',
    'bazi.leapNoteHas': 'This year has a leap month {m}; tick the box if you were born in it.',
    'bazi.leapNoteNone': 'This year has no leap month.',
    'bazi.calcBtn': 'Cast the chart now',
    'bazi.errDate': 'Please enter a valid date of birth first.',
    'bazi.errLunarDate': 'Please enter a valid lunar month and day (month 1–12, day 1–30).',
    'bazi.errLeapMismatch': 'That month is not a leap month in this year; untick the leap box or switch to the solar calendar.',
    'bazi.errCalendar': 'Calendar conversion failed for this date; please check the date or enter it in the solar calendar.',
    'bazi.errDateSubmit': 'Please complete the year, month, and day of birth first.',
    'bazi.pillarYear': 'Year',
    'bazi.pillarMonth': 'Month',
    'bazi.pillarDay': 'Day',
    'bazi.pillarHour': 'Hour',
    'bazi.dayMasterMark': 'Day Master',
    'bazi.dayMasterIs': 'Day Master',
    'bazi.zodiac': 'Year of the ',
    'bazi.elDist': 'Five Elements',
    'bazi.el.wood': 'Wood',
    'bazi.el.fire': 'Fire',
    'bazi.el.earth': 'Earth',
    'bazi.el.metal': 'Metal',
    ...
    'bazi.guideAfterChart': 'Your chart is cast and drafted in the box. Add what you ask about right now (career, love or the year ahead), then present it yourself.',
